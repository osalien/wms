<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-select v-model="listQuery.status" placeholder="选择状态" clearable class="filter-item" style="width: 130px;margin-left: 15px">
    ...
    <div style="margin-top: 20px">
      <el-button @click="setCurrent()" style="background-color: #409EFF;color:white">√批量通过</el-button>
      <el-button @click="setCurrent()" style="background-color: #409EFF;color:white">×批量拒绝</el-button>
    </div>
    <el-table
      :key="tableKey"
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
        <el-form-item label="盘点方式">
          <el-select v-model="temp.type" class="filter-item" placeholder="选择盘点方式">
        ...
        <el-form-item label="单号" prop="title">
          <el-input v-model="temp.title" />
        </el-form-item>
        <el-form-item>
           <el-button type="primary">生产盘点单</el-button>
        </el-form-item>
        <el-form-item>
...
const dataFromOptions = [
  ...
  { key: '1', display_name: 'PDA' },
  { key: '1', display_name: '盘点' }
]
...
const calendarStatusOptions = [
  { key: '0', display_name: '已提交' },
  { key: '1', display_name: '已审核' },
  { key: '2', display_name: '已拒绝' },
  { key: '3', display_name: '已出库' }
]
